...
export type getV1MathInventoryMetricsResponse = 
  ...
  | { _tag: "TimelineResponse"; readonly data: timelineDataPoint_dict_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) }
  | { _tag: "TimelineDataPoint"; readonly period_start: string; readonly period_end: string; readonly is_forecast: boolean; readonly value: Dict_t<string>; readonly compare_value: (undefined | Dict_t<string>); readonly compare_diff: (undefined | Dict_t<string>); readonly compare_percent_diff: (undefined | floatOrDict) };

export type getV1MathOrganicExecutiveSummaryResponse = 
    { _tag: "OrganicExecutiveSummaryResponseSchema"; readonly organic_sales: number; readonly organic_impressions: (undefined | number); readonly organic_ctr: (undefined | number); readonly organic_clicks: number; readonly organic_cvr: number; readonly organic_orders: number; readonly organic_units_sold: number }
  | { _tag: "OrganicExecutiveSummaryWithForecastBreakdown"; readonly organic_sales: number; readonly organic_impressions: (undefined | number); readonly organic_ctr: (undefined | number); readonly organic_clicks: number; readonly organic_cvr: number; readonly organic_orders: number; readonly organic_units_sold: number; readonly real: organicExecutiveSummaryResponseSchema; readonly forecasted: organicExecutiveSummaryResponseSchema }
  | { _tag: "TimelineResponse"; readonly data: timelineDataPoint_dict_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) }
  | { _tag: "TimelineDataPoint"; readonly period_start: string; readonly period_end: string; readonly is_forecast: boolean; readonly value: Dict_t<string>; readonly compare_value: (undefined | Dict_t<string>); readonly compare_diff: (undefined | Dict_t<string>); readonly compare_percent_diff: (undefined | floatOrDict) };

export type getV1MathAdsExecutiveSummaryResponse = 
    { _tag: "AdsExecutiveSummaryResponseSchema"; readonly ad_sales: number; readonly ad_spend: number; readonly ad_impressions: number; readonly ad_ctr: (undefined | number); readonly ad_clicks: number; readonly ad_cvr: (undefined | number); readonly ad_orders: number; readonly ad_units_sold: number; readonly acos: (undefined | number); readonly roas: (undefined | number); readonly cpc: (undefined | number); readonly cpm: (undefined | number); readonly time_in_budget: (undefined | number); readonly ad_tos_is: (undefined | number); readonly ads_non_optimal_spend: (undefined | number) }
  | { _tag: "AdsExecutiveSummaryWithForecastBreakdown"; readonly ad_sales: number; readonly ad_spend: number; readonly ad_impressions: number; readonly ad_ctr: (undefined | number); readonly ad_clicks: number; readonly ad_cvr: (undefined | number); readonly ad_orders: number; readonly ad_units_sold: number; readonly acos: (undefined | number); readonly roas: (undefined | number); readonly cpc: (undefined | number); readonly cpm: (undefined | number); readonly time_in_budget: (undefined | number); readonly ad_tos_is: (undefined | number); readonly ads_non_optimal_spend: (undefined | number); readonly real: adsExecutiveSummaryResponseSchema; readonly forecasted: adsExecutiveSummaryResponseSchema }
  | { _tag: "TimelineResponse"; readonly data: timelineDataPoint_AdsExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) }
...
export type postV1MathAdsExecutiveSummaryResponse = 
    { _tag: "AdsExecutiveSummaryResponseSchema"; readonly ad_sales: number; readonly ad_spend: number; readonly ad_impressions: number; readonly ad_ctr: (undefined | number); readonly ad_clicks: number; readonly ad_cvr: (undefined | number); readonly ad_orders: number; readonly ad_units_sold: number; readonly acos: (undefined | number); readonly roas: (undefined | number); readonly cpc: (undefined | number); readonly cpm: (undefined | number); readonly time_in_budget: (undefined | number); readonly ad_tos_is: (undefined | number); readonly ads_non_optimal_spend: (undefined | number) }
  | { _tag: "AdsExecutiveSummaryWithForecastBreakdown"; readonly ad_sales: number; readonly ad_spend: number; readonly ad_impressions: number; readonly ad_ctr: (undefined | number); readonly ad_clicks: number; readonly ad_cvr: (undefined | number); readonly ad_orders: number; readonly ad_units_sold: number; readonly acos: (undefined | number); readonly roas: (undefined | number); readonly cpc: (undefined | number); readonly cpm: (undefined | number); readonly time_in_budget: (undefined | number); readonly ad_tos_is: (undefined | number); readonly ads_non_optimal_spend: (undefined | number); readonly real: adsExecutiveSummaryResponseSchema; readonly forecasted: adsExecutiveSummaryResponseSchema }
  | { _tag: "WhatifResponse"; readonly baseline: adsExecutiveSummaryResponseSchema; readonly projected: adsExecutiveSummaryResponseSchema; readonly diff: Dict_t<(undefined | number)>; readonly percent_diff: Dict_t<(undefined | number)>; readonly whatif_applied: Dict_t<whatifAppliedEntry>; readonly model_info: whatifModelInfo; readonly warnings: (undefined | string[]) }
  | { _tag: "WhatifTimelineResponse"; readonly data: whatifTimelineDataPoint_AdsExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) };

export type getV1MathAttributionExecutiveSummaryResponse = 
    { _tag: "AttributionExecutiveSummaryResponseSchema"; readonly attribution_sales: (undefined | number); readonly attribution_spend: (undefined | number); readonly attribution_impressions: (undefined | number); readonly attribution_ctr: (undefined | number); readonly attribution_clicks: (undefined | number); readonly attribution_cvr: (undefined | number); readonly attribution_orders: (undefined | number); readonly attribution_units_sold: (undefined | number); readonly attribution_acos: (undefined | number); readonly attribution_roas: (undefined | number); readonly attribution_cpc: (undefined | number); readonly attribution_cpm: (undefined | number) }
  | { _tag: "AttributionExecutiveSummaryWithForecastBreakdown"; readonly attribution_sales: (undefined | number); readonly attribution_spend: (undefined | number); readonly attribution_impressions: (undefined | number); readonly attribution_ctr: (undefined | number); readonly attribution_clicks: (undefined | number); readonly attribution_cvr: (undefined | number); readonly attribution_orders: (undefined | number); readonly attribution_units_sold: (undefined | number); readonly attribution_acos: (undefined | number); readonly attribution_roas: (undefined | number); readonly attribution_cpc: (undefined | number); readonly attribution_cpm: (undefined | number); readonly real: attributionExecutiveSummaryResponseSchema; readonly forecasted: attributionExecutiveSummaryResponseSchema }
  | { _tag: "TimelineResponse"; readonly data: timelineDataPoint_AttributionExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) }
  | { _tag: "TimelineDataPoint"; readonly period_start: string; readonly period_end: string; readonly is_forecast: boolean; readonly value: attributionExecutiveSummaryResponseSchema; readonly compare_value: (undefined | attributionExecutiveSummaryResponseSchema); readonly compare_diff: (undefined | attributionExecutiveSummaryResponseSchema); readonly compare_percent_diff: (undefined | floatOrDict) };

export type postV1MathAttributionExecutiveSummaryResponse = 
    { _tag: "AttributionExecutiveSummaryResponseSchema"; readonly attribution_sales: (undefined | number); readonly attribution_spend: (undefined | number); readonly attribution_impressions: (undefined | number); readonly attribution_ctr: (undefined | number); readonly attribution_clicks: (undefined | number); readonly attribution_cvr: (undefined | number); readonly attribution_orders: (undefined | number); readonly attribution_units_sold: (undefined | number); readonly attribution_acos: (undefined | number); readonly attribution_roas: (undefined | number); readonly attribution_cpc: (undefined | number); readonly attribution_cpm: (undefined | number) }
  | { _tag: "AttributionExecutiveSummaryWithForecastBreakdown"; readonly attribution_sales: (undefined | number); readonly attribution_spend: (undefined | number); readonly attribution_impressions: (undefined | number); readonly attribution_ctr: (undefined | number); readonly attribution_clicks: (undefined | number); readonly attribution_cvr: (undefined | number); readonly attribution_orders: (undefined | number); readonly attribution_units_sold: (undefined | number); readonly attribution_acos: (undefined | number); readonly attribution_roas: (undefined | number); readonly attribution_cpc: (undefined | number); readonly attribution_cpm: (undefined | number); readonly real: attributionExecutiveSummaryResponseSchema; readonly forecasted: attributionExecutiveSummaryResponseSchema }
  | { _tag: "WhatifResponse"; readonly baseline: attributionExecutiveSummaryResponseSchema; readonly projected: attributionExecutiveSummaryResponseSchema; readonly diff: Dict_t<(undefined | number)>; readonly percent_diff: Dict_t<(undefined | number)>; readonly whatif_applied: Dict_t<whatifAppliedEntry>; readonly model_info: whatifModelInfo; readonly warnings: (undefined | string[]) }
  | { _tag: "WhatifTimelineResponse"; readonly data: whatifTimelineDataPoint_AttributionExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) };

export type getV1MathCfoExecutiveSummaryResponse = 
    { _tag: "CFOExecutiveSummaryResponseSchema"; readonly available_capital: (undefined | number); readonly frozen_capital: (undefined | number); readonly borrowed_capital: (undefined | number); readonly gross_profit: (undefined | number); readonly gross_margin: (undefined | number); readonly contribution_profit: (undefined | number); readonly contribution_margin: (undefined | number); readonly net_profit: (undefined | number); readonly net_margin: (undefined | number); readonly opex: (undefined | number); readonly roi: (undefined | number); readonly cost_of_goods_sold: number; readonly amazon_fees: number }
  | { _tag: "CFOExecutiveSummaryWithForecastBreakdown"; readonly available_capital: (undefined | number); readonly frozen_capital: (undefined | number); readonly borrowed_capital: (undefined | number); readonly gross_profit: (undefined | number); readonly gross_margin: (undefined | number); readonly contribution_profit: (undefined | number); readonly contribution_margin: (undefined | number); readonly net_profit: (undefined | number); readonly net_margin: (undefined | number); readonly opex: (undefined | number); readonly roi: (undefined | number); readonly cost_of_goods_sold: number; readonly amazon_fees: number; readonly real: cFOExecutiveSummaryResponseSchema; readonly forecasted: cFOExecutiveSummaryResponseSchema }
  | { _tag: "TimelineResponse"; readonly data: timelineDataPoint_CFOExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) }
  | { _tag: "TimelineDataPoint"; readonly period_start: string; readonly period_end: string; readonly is_forecast: boolean; readonly value: cFOExecutiveSummaryResponseSchema; readonly compare_value: (undefined | cFOExecutiveSummaryResponseSchema); readonly compare_diff: (undefined | cFOExecutiveSummaryResponseSchema); readonly compare_percent_diff: (undefined | floatOrDict) };

export type postV1MathCfoExecutiveSummaryResponse = 
    { _tag: "CFOExecutiveSummaryResponseSchema"; readonly available_capital: (undefined | number); readonly frozen_capital: (undefined | number); readonly borrowed_capital: (undefined | number); readonly gross_profit: (undefined | number); readonly gross_margin: (undefined | number); readonly contribution_profit: (undefined | number); readonly contribution_margin: (undefined | number); readonly net_profit: (undefined | number); readonly net_margin: (undefined | number); readonly opex: (undefined | number); readonly roi: (undefined | number); readonly cost_of_goods_sold: number; readonly amazon_fees: number }
  | { _tag: "CFOExecutiveSummaryWithForecastBreakdown"; readonly available_capital: (undefined | number); readonly frozen_capital: (undefined | number); readonly borrowed_capital: (undefined | number); readonly gross_profit: (undefined | number); readonly gross_margin: (undefined | number); readonly contribution_profit: (undefined | number); readonly contribution_margin: (undefined | number); readonly net_profit: (undefined | number); readonly net_margin: (undefined | number); readonly opex: (undefined | number); readonly roi: (undefined | number); readonly cost_of_goods_sold: number; readonly amazon_fees: number; readonly real: cFOExecutiveSummaryResponseSchema; readonly forecasted: cFOExecutiveSummaryResponseSchema }
  | { _tag: "WhatifResponse"; readonly baseline: cFOExecutiveSummaryResponseSchema; readonly projected: cFOExecutiveSummaryResponseSchema; readonly diff: Dict_t<(undefined | number)>; readonly percent_diff: Dict_t<(undefined | number)>; readonly whatif_applied: Dict_t<whatifAppliedEntry>; readonly model_info: whatifModelInfo; readonly warnings: (undefined | string[]) }
  | { _tag: "WhatifTimelineResponse"; readonly data: whatifTimelineDataPoint_CFOExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) };

export type getV1MathInventoryMetricsExecutiveSummaryResponse = 
    { _tag: "InventoryExecutiveSummaryResponseSchema"; readonly fba_in_stock_rate: (undefined | number); readonly fbt_in_stock_rate: (undefined | number); readonly three_pl_in_stock_rate: (undefined | number); readonly storage_costs: (undefined | number); readonly shipping_costs: (undefined | number); readonly forecasting_accuracy: (undefined | number); readonly inventory_turnover: (undefined | number); readonly safety_stock: (undefined | number); readonly doi_available: (undefined | number); readonly total_doi: (undefined | number); readonly estimated_stock_out_date: (undefined | string) }
  | { _tag: "InventoryExecutiveSummaryWithForecastBreakdown"; readonly fba_in_stock_rate: (undefined | number); readonly fbt_in_stock_rate: (undefined | number); readonly three_pl_in_stock_rate: (undefined | number); readonly storage_costs: (undefined | number); readonly shipping_costs: (undefined | number); readonly forecasting_accuracy: (undefined | number); readonly inventory_turnover: (undefined | number); readonly safety_stock: (undefined | number); readonly doi_available: (undefined | number); readonly total_doi: (undefined | number); readonly estimated_stock_out_date: (undefined | string); readonly real: inventoryExecutiveSummaryResponseSchema; readonly forecasted: inventoryExecutiveSummaryResponseSchema }
  | { _tag: "TimelineResponse"; readonly data: timelineDataPoint_InventoryExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) }
  | { _tag: "TimelineDataPoint"; readonly period_start: string; readonly period_end: string; readonly is_forecast: boolean; readonly value: inventoryExecutiveSummaryResponseSchema; readonly compare_value: (undefined | inventoryExecutiveSummaryResponseSchema); readonly compare_diff: (undefined | inventoryExecutiveSummaryResponseSchema); readonly compare_percent_diff: (undefined | floatOrDict) };

export type postV1MathInventoryMetricsExecutiveSummaryResponse = 
    { _tag: "InventoryExecutiveSummaryResponseSchema"; readonly fba_in_stock_rate: (undefined | number); readonly fbt_in_stock_rate: (undefined | number); readonly three_pl_in_stock_rate: (undefined | number); readonly storage_costs: (undefined | number); readonly shipping_costs: (undefined | number); readonly forecasting_accuracy: (undefined | number); readonly inventory_turnover: (undefined | number); readonly safety_stock: (undefined | number); readonly doi_available: (undefined | number); readonly total_doi: (undefined | number); readonly estimated_stock_out_date: (undefined | string) }
  | { _tag: "InventoryExecutiveSummaryWithForecastBreakdown"; readonly fba_in_stock_rate: (undefined | number); readonly fbt_in_stock_rate: (undefined | number); readonly three_pl_in_stock_rate: (undefined | number); readonly storage_costs: (undefined | number); readonly shipping_costs: (undefined | number); readonly forecasting_accuracy: (undefined | number); readonly inventory_turnover: (undefined | number); readonly safety_stock: (undefined | number); readonly doi_available: (undefined | number); readonly total_doi: (undefined | number); readonly estimated_stock_out_date: (undefined | string); readonly real: inventoryExecutiveSummaryResponseSchema; readonly forecasted: inventoryExecutiveSummaryResponseSchema }
  | { _tag: "WhatifResponse"; readonly baseline: inventoryExecutiveSummaryResponseSchema; readonly projected: inventoryExecutiveSummaryResponseSchema; readonly diff: Dict_t<(undefined | number)>; readonly percent_diff: Dict_t<(undefined | number)>; readonly whatif_applied: Dict_t<whatifAppliedEntry>; readonly model_info: whatifModelInfo; readonly warnings: (undefined | string[]) }
  | { _tag: "WhatifTimelineResponse"; readonly data: whatifTimelineDataPoint_InventoryExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) };

export type getV1MathMarketIntelligenceExecutiveSummaryResponse = 
    { _tag: "MarketIntelligenceExecutiveSummaryResponseSchema"; readonly market_total_sales: (undefined | number); readonly brand_market_share: (undefined | number); readonly market_average_price: (undefined | number); readonly market_total_units_sold: (undefined | number); readonly market_asin_count: (undefined | number); readonly market_promotion_value: (undefined | number); readonly market_promotion_count: (undefined | number); readonly market_review_score: (undefined | number); readonly market_pos: (undefined | number); readonly market_ad_spend: (undefined | number) }
  | { _tag: "TimelineResponse"; readonly data: timelineDataPoint_MarketIntelligenceExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) }
  | { _tag: "TimelineDataPoint"; readonly period_start: string; readonly period_end: string; readonly is_forecast: boolean; readonly value: marketIntelligenceExecutiveSummaryResponseSchema; readonly compare_value: (undefined | marketIntelligenceExecutiveSummaryResponseSchema); readonly compare_diff: (undefined | marketIntelligenceExecutiveSummaryResponseSchema); readonly compare_percent_diff: (undefined | floatOrDict) };

export type postV1MathMarketIntelligenceExecutiveSummaryResponse = 
    { _tag: "MarketIntelligenceExecutiveSummaryResponseSchema"; readonly market_total_sales: (undefined | number); readonly brand_market_share: (undefined | number); readonly market_average_price: (undefined | number); readonly market_total_units_sold: (undefined | number); readonly market_asin_count: (undefined | number); readonly market_promotion_value: (undefined | number); readonly market_promotion_count: (undefined | number); readonly market_review_score: (undefined | number); readonly market_pos: (undefined | number); readonly market_ad_spend: (undefined | number) }
  | { _tag: "MarketIntelligenceExecutiveSummaryWithForecastBreakdown"; readonly market_total_sales: (undefined | number); readonly brand_market_share: (undefined | number); readonly market_average_price: (undefined | number); readonly market_total_units_sold: (undefined | number); readonly market_asin_count: (undefined | number); readonly market_promotion_value: (undefined | number); readonly market_promotion_count: (undefined | number); readonly market_review_score: (undefined | number); readonly market_pos: (undefined | number); readonly market_ad_spend: (undefined | number); readonly real: marketIntelligenceExecutiveSummaryResponseSchema; readonly forecasted: marketIntelligenceExecutiveSummaryResponseSchema }
  | { _tag: "WhatifResponse"; readonly baseline: marketIntelligenceExecutiveSummaryResponseSchema; readonly projected: marketIntelligenceExecutiveSummaryResponseSchema; readonly diff: Dict_t<(undefined | number)>; readonly percent_diff: Dict_t<(undefined | number)>; readonly whatif_applied: Dict_t<whatifAppliedEntry>; readonly model_info: whatifModelInfo; readonly warnings: (undefined | string[]) }
  | { _tag: "WhatifTimelineResponse"; readonly data: whatifTimelineDataPoint_MarketIntelligenceExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) };

export type postV1MathOrganicExecutiveSummaryResponse = 
    { _tag: "OrganicExecutiveSummaryResponseSchema"; readonly organic_sales: number; readonly organic_impressions: (undefined | number); readonly organic_ctr: (undefined | number); readonly organic_clicks: number; readonly organic_cvr: number; readonly organic_orders: number; readonly organic_units_sold: number }
  | { _tag: "OrganicExecutiveSummaryWithForecastBreakdown"; readonly organic_sales: number; readonly organic_impressions: (undefined | number); readonly organic_ctr: (undefined | number); readonly organic_clicks: number; readonly organic_cvr: number; readonly organic_orders: number; readonly organic_units_sold: number; readonly real: organicExecutiveSummaryResponseSchema; readonly forecasted: organicExecutiveSummaryResponseSchema }
  | { _tag: "WhatifResponse"; readonly baseline: organicExecutiveSummaryResponseSchema; readonly projected: organicExecutiveSummaryResponseSchema; readonly diff: Dict_t<(undefined | number)>; readonly percent_diff: Dict_t<(undefined | number)>; readonly whatif_applied: Dict_t<whatifAppliedEntry>; readonly model_info: whatifModelInfo; readonly warnings: (undefined | string[]) }
  | { _tag: "WhatifTimelineResponse"; readonly data: whatifTimelineDataPoint_OrganicExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) };

export type getV1MathTotalExecutiveSummaryResponse = 
    { _tag: "TotalExecutiveSummaryResponseSchema"; readonly total_sales: (undefined | number); readonly total_spend: (undefined | number); readonly total_impressions: (undefined | number); readonly ctr: (undefined | number); readonly total_clicks: (undefined | number); readonly cvr: (undefined | number); readonly total_orders: (undefined | number); readonly total_units_sold: (undefined | number); readonly total_ntb_orders: (undefined | number); readonly tacos: (undefined | number); readonly mer: (undefined | number); readonly lost_sales: (undefined | number) }
  | { _tag: "TotalExecutiveSummaryWithForecastBreakdown"; readonly total_sales: (undefined | number); readonly total_spend: (undefined | number); readonly total_impressions: (undefined | number); readonly ctr: (undefined | number); readonly total_clicks: (undefined | number); readonly cvr: (undefined | number); readonly total_orders: (undefined | number); readonly total_units_sold: (undefined | number); readonly total_ntb_orders: (undefined | number); readonly tacos: (undefined | number); readonly mer: (undefined | number); readonly lost_sales: (undefined | number); readonly real: totalExecutiveSummaryResponseSchema; readonly forecasted: totalExecutiveSummaryResponseSchema }
  | { _tag: "TimelineResponse"; readonly data: timelineDataPoint_TotalExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) }
  | { _tag: "TimelineDataPoint"; readonly period_start: string; readonly period_end: string; readonly is_forecast: boolean; readonly value: totalExecutiveSummaryResponseSchema; readonly compare_value: (undefined | totalExecutiveSummaryResponseSchema); readonly compare_diff: (undefined | totalExecutiveSummaryResponseSchema); readonly compare_percent_diff: (undefined | floatOrDict) };

export type postV1MathTotalExecutiveSummaryResponse = 
    { _tag: "TotalExecutiveSummaryResponseSchema"; readonly total_sales: (undefined | number); readonly total_spend: (undefined | number); readonly total_impressions: (undefined | number); readonly ctr: (undefined | number); readonly total_clicks: (undefined | number); readonly cvr: (undefined | number); readonly total_orders: (undefined | number); readonly total_units_sold: (undefined | number); readonly total_ntb_orders: (undefined | number); readonly tacos: (undefined | number); readonly mer: (undefined | number); readonly lost_sales: (undefined | number) }
  | { _tag: "TotalExecutiveSummaryWithForecastBreakdown"; readonly total_sales: (undefined | number); readonly total_spend: (undefined | number); readonly total_impressions: (undefined | number); readonly ctr: (undefined | number); readonly total_clicks: (undefined | number); readonly cvr: (undefined | number); readonly total_orders: (undefined | number); readonly total_units_sold: (undefined | number); readonly total_ntb_orders: (undefined | number); readonly tacos: (undefined | number); readonly mer: (undefined | number); readonly lost_sales: (undefined | number); readonly real: totalExecutiveSummaryResponseSchema; readonly forecasted: totalExecutiveSummaryResponseSchema }
  | { _tag: "WhatifResponse"; readonly baseline: totalExecutiveSummaryResponseSchema; readonly projected: totalExecutiveSummaryResponseSchema; readonly diff: Dict_t<(undefined | number)>; readonly percent_diff: Dict_t<(undefined | number)>; readonly whatif_applied: Dict_t<whatifAppliedEntry>; readonly model_info: whatifModelInfo; readonly warnings: (undefined | string[]) }
  | { _tag: "WhatifTimelineResponse"; readonly data: whatifTimelineDataPoint_TotalExecutiveSummaryResponseSchema_[]; readonly period_start: string; readonly period_end: string; readonly period: (undefined | string) };
